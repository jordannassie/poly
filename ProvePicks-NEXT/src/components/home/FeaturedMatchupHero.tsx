...
export default function FeaturedMatchupHero(p: Props) {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-black/30 p-8">
      <div
      ...
      <div className="relative">
        ...
        <div className="mt-8 flex justify-center">
          <a
            href={ctaHref}
            className="rounded-xl bg-white/15 px-6 py-3 text-sm font-semibold hover:bg-white/20"
          >
            View Matchup
          </a>
        </div>
